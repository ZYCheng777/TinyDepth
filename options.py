...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["eigen_zhou", "eigen_full", "odom", "benchmark", "tmp", "eigen_and_odom"],
                                 default="eigen_zhou")
        ...
        self.parser.add_argument("--dataset",
                                 ...
                                 default="kitti",
                                 choices=["kitti", "kitti_odom", "kitti_depth", "kitti_test", "kitti_stereo"])
        ...
        self.parser.add_argument("--eval_split",
                                 ...
                                 default="eigen",
                                 choices=[
                                    "eigen", "eigen_benchmark", "benchmark", "odom_9", "odom_10", "make3d", "improved_eigen"],
